        ...
        <div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <input
              ...
              className="bg-slate-900 border border-slate-700 rounded-xl p-3 text-slate-100 placeholder-slate-600 outline-none focus:border-violet-500 transition-all"
            />
            <input
              type="text"
              value={defaultWallet}
              ...
              placeholder="T..."
              className="md:col-span-2 bg-slate-900 border border-slate-700 rounded-xl p-3 text-slate-100 placeholder-slate-600 outline-none focus:border-violet-500 transition-all"
            />
          </div>
        </div>
